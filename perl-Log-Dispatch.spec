...
Version  : 2.67
Release  : 1
URL      : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/Log-Dispatch-2.67.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/Log-Dispatch-2.67.tar.gz
...
Requires: perl-Log-Dispatch-man
...
%package man
Summary: man components for the perl-Log-Dispatch package.
Group: Default

%description man
man components for the perl-Log-Dispatch package.


%prep
tar -xf %{SOURCE1}
cd ..
%setup -q -n Log-Dispatch-2.67
mkdir -p %{_topdir}/BUILD/Log-Dispatch-2.67/deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Log-Dispatch-2.67/deblicense/
