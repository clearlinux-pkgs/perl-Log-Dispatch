...
%prep
%setup -q -n Log-Dispatch-2.71
cd %{_builddir}/Log-Dispatch-2.71
...
cp %{_builddir}/Log-Dispatch-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Log-Dispatch/e4acb8ef12b64ec28720bd578f175fed75bdd85d || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Log-Dispatch/e4acb8ef12b64ec28720bd578f175fed75bdd85d
